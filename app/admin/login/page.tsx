      ...
      <div className="w-full max-w-md rounded-2xl border border-slate-200 bg-white p-8 shadow-xl shadow-slate-200/50">
        ...
        <div className="mb-6 flex items-center gap-3">
          ...
          <div className="leading-none">
            ...
            <p className="text-lg font-bold text-slate-900">Stocks</p>
          </div>
        </div>
        ...
        <form onSubmit={submit} className="mt-8 space-y-4">
          <div>
            ...
            <div className="relative mt-1">
              <input
                ...
                className="w-full rounded-xl border border-slate-200 px-4 py-3 text-slate-900 outline-none ring-red-600/20 focus:border-red-600 focus:ring-4"
                placeholder="••••••••"
                autoComplete="off"
              />
              <button
          ...
          <button
            ...
            className="w-full rounded-xl py-3 text-sm font-semibold text-white shadow-sm transition hover:opacity-90 disabled:opacity-50"
